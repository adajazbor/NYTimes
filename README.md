...
* [x] Number of columns depends on a screen size
* [x] Checking Internet connection by registering on android.net.conn.CONNECTIVITY_CHANGE broadcast in addition to the sugested solution
## Video Walkthrough
